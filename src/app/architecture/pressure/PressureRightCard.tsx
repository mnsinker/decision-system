...
export default function PressureRightCard({
  ...
  return (
    <div className="relative h-full overflow-hidden bg-gradient-to-br from-[#0c2a26] via-[#051614] to-[#020a09] px-7 py-5 text-white">
      {/* ambient */}
      ...
      */}
      ...
      <div className="relative z-10 flex h-full min-h-[480px] flex-col justify-between">
        {/* TOP STAGE CONTAINER */}
        <div className="w-full shrink-0">
          {/* label */}
          <div className={cn("mb-4", semanticVisual.pressureVoice.emerald)}>
            {sectionLabel}
          </div>

          {/* signal */}
          <div className="relative mb-4 overflow-hidden rounded-[1.2rem] border border-emerald-500/20 bg-gradient-to-r from-emerald-500/[0.08] to-transparent px-4 py-2.5">
        ...
        <div className="mt-auto flex min-h-[420px] w-full flex-1 flex-col justify-between">
          {/* shell */}
          <div className="relative flex flex-1 items-center justify-center overflow-hidden rounded-[1.35rem] border border-white/10 bg-gradient-to-b from-white/[0.04] to-transparent px-5 py-4 shadow-[0_25px_60px_-20px_rgba(0,0,0,0.45)] backdrop-blur-3xl">
          ...
          {architectureShiftTitle && architectureShiftMsg && (
            <div className="rounded-1xl mt-4 shrink-0 border border-emerald-500/10 bg-white/[0.03] p-3 backdrop-blur-xl">
