        ...
        <div className="relative h-[252px]">
          <div className="absolute top-6 right-20">
            <div className="flex items-center gap-3.5">
              ...
              <div className="rounded-2xl border border-indigo-500/20 bg-indigo-500/[0.06] px-4 py-3 text-[13px] leading-[1.45] text-slate-300">
                {nodes[0]}
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-[96px] left-2">
            <div className="flex items-center gap-3.5">
              ...
              <div className="rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-[13px] leading-[1.45] text-slate-300">
                {nodes[1]}
              </div>
            </div>
          </div>
          ...
          <div className="absolute right-12 bottom-1">
            <div className="flex items-center gap-3.5">
              ...
              <div className="rounded-2xl border border-rose-500/20 bg-rose-500/[0.06] px-4 py-3 text-[13px] leading-[1.45] text-slate-300">
                {nodes[3]}
              </div>
            </div>
          </div>
